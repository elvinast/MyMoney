        ...
        NavigationView {
            ZStack {
                ...
                VStack {
                    ...
                    ToolbarModelView(title: "Details", button1Icon: Constants.shared.IMAGE_DELETE_ICON, button2Icon: Constants.shared.IMAGE_SHARE_ICON) { self.presentationMode.wrappedValue.dismiss() }
                    ...
                    ScrollView(showsIndicators: false) {
                        ...
                        VStack(spacing: 24) {
                            ...
                            ExpenseDetailedListView(title: "Transaction type", description: viewModel.expenseObj.type == Constants.shared.TRANS_TYPE_INCOME ? "Income" : "Expense" )
                            ExpenseDetailedListView(title: "Tag", description: getTransTagTitle(transTag: TransactionsTag(rawValue: viewModel.expenseObj.tag ?? "") ?? .TRANS_TAG_OTHERS))
